...
Click the Fork icon image:http://hubpress.github.io/img/fork-icon.png[Fork,80] to create a copy of this repository within your GitHub account.
...
+
image:http://hubpress.github.io/img/edit-config.png[Edit config]
+
...
+
image:http://hubpress.github.io/img/home-install.png[Install complete,300]
...
+
image:http://hubpress.github.io/img/switch-gh-pages.png[Install complete,300]
+
. Set the required values in `hubpress/config.json`
+
image:http://hubpress.github.io/img/edit-config-gh-pages.png[Edit config]
+
The following parameters are mandatory:
+
* `username`, which is your GitHub user name. For example `janesmith`.
